...
`verifier-tests-mutation.sh` casse **vingt-sept fois** le comportement testé
...
session et de la preuve d'identité depuis LS-81, quatre du journal des
connexions depuis LS-80. Il vérifie d'abord que les deux projets de test sont
