...
**211 tickets terminés sur 238 hors epics**, les deux termes relevés dans Jira
le **23 septembre 2026** en fin de session, et jamais dérivés l'un de l'autre :
27 tickets non terminés relevés séparément, et 238 − 27 retombe bien sur 211.
**La recette de l'exploitante du 23 septembre** a ouvert LS-238 à LS-248 :
dix sont clos le jour même, LS-246 par un arbitrage sans code, et **LS-239
reste ouvert**, le retour en bas de page n'ayant pas été reproduit.
...
**Douze des vingt-sept tickets ouverts attendent l'exploitante** : les dix de
l'epic LS-22, photographies, textes, tarifs et contenus juridiques, LS-19, la
médiation, qui suppose une adhésion à souscrire, et LS-239, dont la
reproduction demande son appareil et son geste. Aucun code ne les débloque.
