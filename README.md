...
| 6, durcissement, exploitation et ouverture | LS-7 | découpée le 27 août 2026, **treize stories ouvertes**. LS-168 ajoutée le 3 septembre sur l'instabilité de la suite de bout en bout ; **LS-169 livrée le même jour**, la chaîne ne rejoue plus les tests longs sur un diff documentaire. **Huit de ces stories attendent l'achat du VPS**, LS-151 comprise, contrairement à ce qu'annonçait le journal du 3 septembre. **LS-175 créée le 4 septembre**, quatorzième story ouverte : rien ne créait le compte administrateur de l'exploitante, et elle bloque LS-153 |
...
**105 tickets terminés sur 165, soit 64 %**, relevés le 4 septembre 2026 hors
