...
| 6, durcissement, exploitation et ouverture | LS-7 | découpée le 27 août 2026, **treize stories ouvertes**. LS-168 ajoutée le 3 septembre sur l'instabilité de la suite de bout en bout ; **LS-169 livrée le même jour**, la chaîne ne rejoue plus les tests longs sur un diff documentaire. **Huit de ces stories attendent l'achat du VPS**, LS-151 comprise, contrairement à ce qu'annonçait le journal du 3 septembre. **LS-175 et LS-176 créées le 4 septembre**, quinze stories ouvertes : rien ne créait le compte administrateur de l'exploitante, LS-175 bloquant LS-153 ; et la chaîne de contrôle tourne deux fois par livraison, dix-sept minutes rejouées dont 74 % sur deux étapes, LS-176 |
