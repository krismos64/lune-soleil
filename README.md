...
|---|---|---|
| 2, catalogue, médias et stock multicanal | LS-3 | en cours, **quinze stories ouvertes**. LS-84, LS-146 et LS-162 livrées le 2 septembre ; **LS-165** et **LS-166** créées le même jour par les revues. **LS-171 créée et close le 3 septembre** : un libellé sans espace débordait de 43 px à 320 px sur le détail de commande |
...
**107 tickets terminés sur 168, soit 64 %**, relevés le 4 septembre 2026 hors
epics, après la clôture de LS-176 et LS-177. Six tickets ont été créés le
