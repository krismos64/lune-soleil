...
| 6, durcissement, exploitation et ouverture | LS-7 | découpée le 27 août 2026, **treize stories ouvertes**. LS-168 ajoutée le 3 septembre sur l'instabilité de la suite de bout en bout ; **LS-169 livrée le même jour**, la chaîne ne rejoue plus les tests longs sur un diff documentaire. **Huit de ces stories attendent l'achat du VPS**, LS-151 comprise, contrairement à ce qu'annonçait le journal du 3 septembre. **LS-175 et LS-176 créées le 4 septembre.** LS-175 : rien ne créait le compte administrateur de l'exploitante, elle bloque LS-153. **LS-176 est livrée le même jour**, PR #221 : la chaîne ne se rejoue plus sur `main` après fusion, `npm audit` distingue une panne du registre d'une vulnérabilité, et le navigateur de test est mis en cache. Son critère de découpage en deux jobs reste ouvert, un job sauté comptant comme un succès chez GitHub |
...
**105 tickets terminés sur 166, soit 63 %**, relevés le 4 septembre 2026 hors
epics. Six tickets ont été créés le
