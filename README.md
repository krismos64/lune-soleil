...
|---|---|---|
| 2, catalogue, médias et stock multicanal | LS-3 | en cours, **seize stories ouvertes**, relevé le 4 septembre 2026. **LS-181 créée ce jour** : l'administration livrée est loin du prototype, navigation horizontale quand il la veut latérale, aucune pastille de comptage, et huit rubriques contre onze. LS-84, LS-146 et LS-162 livrées le 2 septembre ; **LS-165** et **LS-166** créées le même jour par les revues. **LS-171 créée et close le 3 septembre** : un libellé sans espace débordait de 43 px à 320 px sur le détail de commande |
...
**108 tickets terminés sur 171, soit 63 %**, relevés le 4 septembre 2026 hors
epics, après la clôture de LS-176, LS-177 et LS-178 et la création de trois
tickets d'interface. Six tickets ont été créés le
