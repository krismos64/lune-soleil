...
| 5, rétractation, conformité et protection des données | LS-6 | **LS-133 et LS-134 livrées le 3 septembre 2026** : le calcul du délai, puis la fonctionnalité en ligne de l'article L221-21, par l'espace client et par lien signé. Trois stories ouvertes : LS-135 qui dépend de LS-33, LS-136 désormais **bloquée par LS-172**, et LS-148 bloquée par LS-141 |
