...
**215 tickets terminés sur 242 hors epics**, les deux termes relevés dans Jira
le **23 septembre 2026** au soir, et jamais dérivés l'un de l'autre : 27
tickets non terminés relevés séparément, et 242 − 27 retombe bien sur 215.
**La recette de l'exploitante du 23 septembre** a ouvert LS-238 à LS-248, tous
clos le jour même : LS-246 par un arbitrage sans code, **LS-239 sans correction**,
arbitrage de Christophe, le retour en bas de page n'ayant pas été reproduit.
...
**Onze des vingt-six tickets ouverts attendent l'exploitante** : les dix de
...
Comptes relevés dans Jira le 23 septembre 2026, `parent = LS-22 AND
