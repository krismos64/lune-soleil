...
| `src/components/donnees-structurees.tsx` | insertion d'un bloc JSON-LD, LS-137 | **aucun `dangerouslySetInnerHTML`**, règle C23. React **n'échappe rien dans un `<script>`**, son contenu étant du texte brut au sens HTML : l'échappement des chevrons est explicite, mesuré, et sans lui un nom de produit portant `</script>` fermerait la balise |
