...
| `schemaModificationAvis` | la modification d'un avis par son auteur, LS-225 : l'avis visé, la note et le commentaire | `ligneCommandeId`, dont l'acceptation permettrait de **déplacer** un avis d'une pièce vers une autre, donc de faire porter une note sur un article que personne n'a noté |
